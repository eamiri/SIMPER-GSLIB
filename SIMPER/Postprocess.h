...
public:
	...
	void GetTalikArea(VectorXd Temp, VectorXd minTemp, VectorXd maxTemp, int time, int iRealization);
	void GetPermafrostArea(VectorXd minTemp, VectorXd maxTemp, int time, int iRealization);
